export const AGENT_EXECUTE_QUEUE = 'agent_execute_queue';
export const AGENT_SNAPSHOT_QUEUE = 'agent_snapshot_queue';
export const AGENT_SETTLEMENT_QUEUE = 'agent_settlement_queue';

export const AGENT_EXECUTE_INTERVAL = 5 * 60 * 1000; // 5 minutes
export const AGENT_SNAPSHOT_INTERVAL = 1 * 60 * 1000; // 1 minute
